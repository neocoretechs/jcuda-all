...
public class JCudaSamplesUtils {
    ...
    /**
     * Creates an array of the specified size, containing double values from
     * the range [0.0d, 1.0d)
     * 
     * @param n The size of the array
     * @return The array of random values
     */
    public static double[] createRandomDoubleData(int n)
    {
        Random random = new Random(0);
     ...
     * @throws IllegalArgumentException If the arrays have different lengths
     */
    public static boolean equalByNorm(double result[], double reference[])
    {
        if (result == null)
        {
            throw new NullPointerException("The result is null");
